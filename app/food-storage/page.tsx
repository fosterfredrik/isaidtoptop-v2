...
export default function FoodStorageCategory() {
    const productsDir = path.join(process.cwd(), 'app/food-storage/products');
            ...
            <div className="bg-white border-b">
                <div className="max-w-4xl mx-auto px-6 py-3">
                    <nav className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-slate-600">Food Storage</span>
                    </nav>
                </div>
            </div>
            <main className="max-w-4xl mx-auto px-6 py-12">
                <div className="mb-8">
                    <h1 className="text-5xl font-bold text-emerald-700 mb-4">Food Storage</h1>
                    <p className="text-xl text-slate-600">We've analyzed {products.length} types of Food Storage to find the top product in each category.</p>
                </div>
