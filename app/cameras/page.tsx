...
export default function CamerasCategory() {
    const productsDir = path.join(process.cwd(), 'app/cameras/products');
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
            ...
            <main className="max-w-4xl mx-auto px-6 py-12">
                <div className="mb-8">
                    <h1 className="text-5xl font-bold text-emerald-700 mb-4">Cameras</h1>
                    <p className="text-xl text-slate-600">We've analyzed {products.length} types of Cameras to find the top product in each category.</p>
                </div>
